      ...
      >
        <div className="container mx-auto px-6 py-32">
          <div className="max-w-3xl">
            ...
            >
              <span className="w-12 h-px bg-accent-300" />
              <span className="text-accent-300 font-medium tracking-widest uppercase text-sm">
                Alcázar de San Juan
              </span>
            </motion.div>
            ...
            <div className="space-y-2 mb-8">
              ...
              >
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-accent-200 via-primary-100 to-accent-300">
                  integral
                </span>
              </motion.h1>
            </div>
            ...
            >
              <span className="w-px h-auto bg-gradient-to-b from-accent-300 to-transparent flex-shrink-0" />
              <p className="text-xl sm:text-2xl text-gray-100 leading-relaxed max-w-xl">
                Especialistas en
                <span className="text-accent-300 font-medium"> suelo pélvico</span>,
                <span className="text-primary-200 font-medium"> embarazo</span>,
                <span className="text-accent-200 font-medium"> fisioterapia invasiva</span> y
                <span className="text-primary-300 font-medium"> pilates terapéutico</span>.
            ...
            >
              <motion.a
                ...
                whileTap={{ scale: 0.98 }}
                className="group relative px-8 py-4 bg-white text-stone-900 rounded-full font-semibold text-lg overflow-hidden shadow-2xl shadow-white/20"
              >
            ...
            >
              ...
              <div className="flex items-center gap-4 bg-white/10 backdrop-blur-md px-6 py-4 rounded-2xl border border-white/20">
                <div className="flex -space-x-2">
                  <span className="w-8 h-8 rounded-full bg-accent-500 flex items-center justify-center">
                  ...
                  <span className="w-8 h-8 rounded-full bg-accent-600 flex items-center justify-center">
                    <svg className="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                    </svg>
                  </span>
                  <span className="w-8 h-8 rounded-full bg-secondary-500 flex items-center justify-center">
                    <svg className="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="text-white">
                  <p className="font-bold">Tratamiento integral</p>
                  <p className="text-sm text-white/70">Basado en evidencia</p>
                </div>
              </div>
            </motion.div>
          </div>
