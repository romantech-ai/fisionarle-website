  ...
  return (
    <footer className="bg-gray-900 text-white">
      ...
      <div className="container mx-auto px-6 py-16">
        ...
        <div className="bg-gradient-to-r from-emerald-600 to-teal-600 rounded-3xl p-8 lg:p-12 mb-16 relative overflow-hidden">
          {/* Decorative circles */}
          ...
          <div className="relative z-10 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
            ...
            <a
              href="https://wa.me/34613004617?text=Hola,%20me%20gustar%C3%ADa%20pedir%20cita%20en%20Fisionarle"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-3 bg-white text-emerald-700 px-8 py-4 rounded-full font-semibold hover:bg-emerald-50 transition-colors whitespace-nowrap"
            >
        ...
        <div className="grid grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-12">
          ...
          <div className="col-span-2 lg:col-span-4">
            ...
            <p className="text-gray-400 leading-relaxed mb-6">
              ...
              Cuidamos de ti en todas las etapas de tu vida con vocación y calidad humana.
            </p>
            {/* Rating badge */}
          ...
          <div className="lg:col-span-3">
            ...
            <ul className="space-y-4">
              <li>
                <a href="tel:+34613004617" className="flex items-center gap-3 text-gray-300 hover:text-emerald-400 transition-colors">
        ...
        <div className="container mx-auto px-6 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="flex flex-col sm:flex-row items-center gap-2 sm:gap-4 text-sm text-gray-500">
              <span>&copy; {currentYear} Fisionarle</span>
